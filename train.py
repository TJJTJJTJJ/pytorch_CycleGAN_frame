...
BaseOptions.parse----BaseOptions.gather_options----train_options.initialize----BaseOptions.initialize
                                              ...
                                              |----data.get_option_setter----_dataset.modify_commandline_options
...
CreateDataLoader----CustomDatasetDataLoader.initialize----BaseDataLoader.initialize
                                                     |----create_dataset----find_dataset_using_name
                                                                       |----unaligned_dataset----unaligned_dataset.initialize

model:
重点：cycle_gan_model.initialize
